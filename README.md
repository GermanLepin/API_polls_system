...
- Реализовано администрирование сайта, с помощью которого можно создавать/выбирать/изменять/удалять опросы, вопросы, варианты ответов и сами ответы, все это реализовано на русском языке и интуитивно понятно.
